...
이 프로젝트에서 Figma로 Html을 통해 웹페이지의 뼈대를 만든 뒤, CSS를 통해 웹페이지를 꾸몄습니다. 이후 MySQL을 통해 각각의 테이블(유저, 즐겨찾기, 좋아요, 답변글 등)을 제작한 뒤, 이 부분을 Node.js와 연결하여 웹 서버를 구축하였습니다. 이를 통해 웹페이지를 구현한 뒤 최종 프로젝트를 제출하였습니다.
